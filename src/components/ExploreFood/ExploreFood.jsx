...
const ExploreFood = () => {
    return (
        <div className='text-center px-[10%] mt-12 mb-16'>
            <h1>Explore Foods</h1>
            <div className="relative flex justify-around my-12">
                <div className="image ml-4 mr-4">
                    ...
                    <h3 className='absolute text-white text-center mt-[-60px] ml-[110px]'>Pizza</h3>
                </div>
                <div className="image ml-4 mr-4">
                    <img src={burger_img} className='rounded-lg w-[320px] h-[400px]' />
                    <h3 className='absolute text-white text-center mt-[-60px] ml-[110px]'>Burger</h3>
                </div>
                <div className="image ml-4 mr-4">
                    <img src={momo_img} className='rounded-lg w-[320px] h-[400px]'/>
                    <h3 className='absolute text-white text-center mt-[-60px] ml-[110px]'>Momo</h3>
                </div>
            </div>
        </div>
    )
